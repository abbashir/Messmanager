...
<head>
    ...
    <style>
        body {
            background: #3e2bc5 url({{asset('assets/admin/img/bg.jpg')}}) no-repeat center center fixed;
...
<div class="login-wrap">
    <div class="login-html" style="text-align: center;">
        ...
        <div class="logo" style="margin-bottom: 40px;">
            <img src="{{asset('assets/admin/img/bg.jpg')}}" alt="logo"
        ...
        <div class="login-form" style="margin-top: 40px;">
            <div class="sign-in-htm">
                ...
                <form method="post" action="{{route('admin.login')}}">
                    @csrf
                    <div class="group">
                        <input placeholder="Username" name="userName" value="admin" class="input" type="text"
                               required="">
                    </div>
                    <div class="group">
                        <input placeholder="Password" name="password" value="admin" class="input" type="password"
                               required="">
                    </div>
